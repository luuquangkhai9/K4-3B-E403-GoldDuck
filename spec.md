...
-->
## §1. User & Job
- Job executor + workflow: Học viên khóa K4 Lớp 3B làm bài Lab tổng hợp tại phòng E403 (workflow: Làm Lab -> Cần tra cứu kiến thức cũ -> Mở VLearn -> Quên vị trí Day/slide -> Phải thoát ra mở từng Day để hỏi bot cục bộ -> Bot trả lời sai ngữ cảnh hoặc trỏ nhầm nguồn -> Mất mạch tư duy làm bài).
...
- Evidence:
  ...
  - ≥5 quote/ví dụ nguyên văn (mã học viên định dạng mẫu 2A2026xxxxx):
    1. "Cần dùng lại khái niệm Prompt của Day 1 khi làm Lab Day 3 mà bot Day 3 báo không có thông tin, phải mở tab mới vào Day 1 rất phiền." — HV-2A202602378.
    2. "Lúc làm bài tập không nhớ nổi cái sơ đồ nằm ở Day 1 hay Day 2, bấm vào từng Day lật từng trang slide mất gần 10 phút." — HV-2A202602449.
    3. "Bấm vào link slide do AI dẫn kèm toàn bị trỏ lệch trang hoặc nhảy sang bài khác không liên quan." — HV-2A202602493.
    4. "Đang ở trang Khóa học của tôi muốn hỏi luôn mà cứ phải click Khóa học -> Day -> mở chat, quá nhiều bước thừa." — HV-2A202602614.
    5. "Cứ tưởng bot ở Day nào thì chỉ được hỏi bài Day đó, không nghĩ nó trả lời được câu hỏi tổng hợp nhiều ngày." — HV-2A202602797.
...
- Mức prototype nhắm tới: [x] Working
  ...
  - Phần thật: Backend FastAPI, Pipeline Hybrid Search (BM25 + Dense `multilingual-e5-small`+ Vision qua RRF, Metadata Filtering theo `--day`), OpenAI API, cơ chế tính top concept gần nhất bằng TF-IDF/local keyword khi từ chối, và bộ render SVG bezier curve nối trực tiếp tọa độ DOM thực tế.
...
- Phân công có tên:
  ...
  - Phạm Hương Giang: Đề xuất, Kiểm soát tính năng hệ thống
- Willing users:
  1. Lê Thanh Tình — 2A202602449 (Học viên phòng E403)
  2. Nguyễn Tiến Lượng — 2A202602378 (Học viên phòng E403)
