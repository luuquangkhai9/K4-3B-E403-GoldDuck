...
- Phân công có tên:
  - Lưu Quang Khải (Đội trưởng): Chốt Canvas CP1, viết `spec.md`, quản trị repository và môi trường chạy demo backend[cite: 2].
  - Tô Anh Đức: [Nhóm tự điền nhiệm vụ]
  - Nguyễn Thị Hạ: [Nhóm tự điền nhiệm vụ]
  - Phạm Hương Giang: [Nhóm tự điền nhiệm vụ]
- Willing users:
